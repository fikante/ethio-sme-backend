...
export default function Landing() {
    const animatedPhrases = useMemo(
        () => [
            ...
            "AI‑Powered Cash‑Flow Lending for Ethiopia’s SMEs",
        ],
        [],
    );
        ...
        <>
            ...
            <div className="min-h-screen bg-white text-[#0A0A0A] dark:bg-[#0A0A0A] dark:text-white">
                ...
                <main className="relative">
                    <section className="mx-auto max-w-7xl px-4 pb-8 pt-14 sm:px-6 lg:px-8 lg:pb-10 lg:pt-20">
                            ...
                            <div className="lg:col-span-7">
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-6 max-w-2xl text-pretty text-base leading-relaxed text-[#525252] dark:text-[#E5E5E5] sm:text-lg">
                                        A fintech AI platform that helps
                                        Ethiopian banks lend to SMEs without
                                        physical collateral.
                                    </p>
                    ...
                    <section
                        id="features"
                        className="mx-auto max-w-7xl px-4 pb-16 pt-8 sm:px-6 lg:px-8 lg:pb-24 lg:pt-10"
                    >
                        <Reveal>
                            <div className="flex items-end justify-between gap-6">
                                <div>
                                    ...
                                    <h2 className="text-3xl font-semibold tracking-tight text-[#0A0A0A] dark:text-white sm:text-4xl">
                                        Underwrite without collateral
                                    </h2>
                                </div>
                            </div>
                        </Reveal>
                        ...
                        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                            <Reveal delayMs={0} className="h-full">
                                <div className="h-full rounded-2xl border border-[#E5E5E5] bg-white p-6 shadow-sm dark:border-[#E5E5E5]/20 dark:bg-[#111111] dark:shadow-none">
                                    ...
                                    <p className="mt-2 text-sm leading-relaxed text-[#525252] dark:text-[#E5E5E5]">
                                        DeepAR and LSTM models predict
                                        worst‑case revenue (P10) to protect
                                        lenders under volatility.
                                    </p>
                                </div>
                            </Reveal>
                            ...
                            <Reveal delayMs={80} className="h-full">
                                <div className="h-full rounded-2xl border border-[#E5E5E5] bg-white p-6 shadow-sm dark:border-[#E5E5E5]/20 dark:bg-[#111111] dark:shadow-none">
                                    ...
                                    <p className="mt-2 text-sm leading-relaxed text-[#525252] dark:text-[#E5E5E5]">
                                        Gamified assessment of integrity,
                                        conscientiousness, and risk tolerance to
                            ...
                            <Reveal delayMs={160} className="h-full">
                                <div className="h-full rounded-2xl border border-[#E5E5E5] bg-white p-6 shadow-sm dark:border-[#E5E5E5]/20 dark:bg-[#111111] dark:shadow-none">
                                    ...
                                    <p className="mt-2 text-sm leading-relaxed text-[#525252] dark:text-[#E5E5E5]">
                                        Every decision backed by transparent,
                                        legally defensible reason codes for
                                        adverse actions.
                                    </p>
                                </div>
                            </Reveal>
                            ...
                            <Reveal delayMs={240} className="h-full">
                                <div className="h-full rounded-2xl border border-[#E5E5E5] bg-white p-6 shadow-sm dark:border-[#E5E5E5]/20 dark:bg-[#111111] dark:shadow-none">
                                    ...
                                    <p className="mt-2 text-sm leading-relaxed text-[#525252] dark:text-[#E5E5E5]">
                                        Real‑time NPV calculation adjusts
                                        automatically to NBE policy rates and
                                        borrower behavior.
                                    </p>
                                </div>
                            </Reveal>
                    ...
                    <section
                        id="how-it-works"
                        className="border-y border-[#E5E5E5] bg-[#E5E5E5]/30 dark:border-[#E5E5E5]/20 dark:bg-[#111111]"
                    >
                        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
                            ...
                            <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                                {[
                                    {
                                        title: "Register and create a business profile",
                                        body: "Sign up as an SME owner and add your business details so underwriting starts with a complete borrower record.",
                                    },
                                    {
                                        title: "Complete psychometric assessment",
                                        body: "Finish the gamified assessment to capture integrity, conscientiousness, and risk tolerance for willingness to repay.",
                                    },
                                    {
                                        title: "Upload transactions & get AI valuation",
                                        body: "Upload 1–6 months of transaction history. Our AI runs time‑series forecasting on your cash flow, then calculates an NPV‑based valuation and loan capacity.",
                                    },
                                    {
                                        title: "Loan provider reviews and decides",
                                        body: "The loan provider reviews your psychometric profile, forecast, and NPV valuation, then approves or rejects your loan application.",
                                    },
                                ].map((step, i) => (
                                    <Reveal
                                        key={step.title}
                                        ...
                                        <div className="relative h-full overflow-hidden rounded-2xl border border-[#E5E5E5] bg-white p-6 dark:border-[#E5E5E5]/20 dark:bg-[#0A0A0A]">
                                            ...
                                            {i < 3 && (
                                                <div className="pointer-events-none absolute right-6 top-6 hidden xl:block">
                                                    <svg
                                                        viewBox="0 0 36 36"
                                                        className="h-10 w-10 text-[#0A0A0A]/15 dark:text-white/15"
                                                        fill="none"
                                                    >
                                                        <path
                                                            d="M6 18h24"
                                ...
                                <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
                                    <div className="lg:col-span-7">
                                        ...
                                        <p className="mt-4 max-w-2xl text-[#525252] dark:text-[#E5E5E5]">
                                            Whether you’re an SME owner building
                                            a digital footprint, or a bank
                    ...
                    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                ...
                                <div className="mt-1 text-xs text-[#525252] dark:text-[#E5E5E5]">
                                    © {new Date().getFullYear()} Ethio‑SME
                                    Valuation System. All rights reserved.
                                </div>
                            </div>
