...
function Icon({
    ...
    return (
        <div
            className={[
                'grid h-10 w-10 place-items-center rounded-xl bg-white/5 text-white/80 ring-1 ring-inset ring-white/10',
                className,
            ].join(' ')}
        >
            {children}
            ...
            <div className="min-h-screen bg-black text-white">
                ...
                <header className="sticky top-0 z-50 border-b border-white/10 bg-black/70 backdrop-blur">
                    <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center gap-3">
                            <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-white/5 ring-1 ring-inset ring-white/10">
                                <svg
                                    viewBox="0 0 24 24"
                                    fill="none"
                                    stroke="currentColor"
                        ...
                        <div>
                            <Link
                                href={route('login')}
                                className="inline-flex items-center justify-center rounded-lg bg-white px-4 py-2 text-sm font-semibold text-black shadow-sm transition hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-white/60 focus:ring-offset-2 focus:ring-offset-black"
                            >
                                Login
                            </Link>
                        </div>
                ...
                <main className="relative">
                    <section className="mx-auto max-w-7xl px-4 pb-16 pt-14 sm:px-6 lg:px-8 lg:pb-24 lg:pt-20">
                        <div className="grid items-center gap-12 lg:grid-cols-12">
                            <div className="lg:col-span-7">
                                <div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-4 py-2 text-sm text-white/80 ring-1 ring-inset ring-white/10">
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                                        ...
                                        <a
                                            href="#how-it-works"
                                            className="inline-flex items-center justify-center rounded-lg border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-white/90 transition hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/40 focus:ring-offset-2 focus:ring-offset-[#071a2b]"
                                        >
                                            See how it works
                                        </a>
                                    </div>
                                    ...
                                    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.05)]">
                                        ...
                                        <div className="relative">
                                            <div className="flex items-center justify-between gap-3">
                                                ...
                                                <span className="rounded-full bg-white/10 px-2.5 py-1 text-xs font-semibold text-white/80 ring-1 ring-inset ring-white/15">
                                                    Explainable
                                                </span>
                                            </div>
                        ...
                        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                            <div className="grid gap-4 text-sm text-white/70 md:grid-cols-3">
                                <div className="flex items-start gap-3">
                                    <span className="mt-0.5 inline-flex h-6 w-6 items-center justify-center rounded-lg bg-white/10 text-white/80 ring-1 ring-inset ring-white/15">
                                        1
                                    </span>
                                    <div>
                                        Built for <span className="font-semibold text-white">NBE Risk‑Based Capital</span>{' '}
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        Local‑first storage under <span className="font-semibold text-white">PDPP</span>{' '}
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        Fairness audit metrics: <span className="font-semibold text-white">SPD</span>{' '}
                                        & <span className="font-semibold text-white">Equalized Odds</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="mt-10 grid gap-6 lg:grid-cols-3">
                                {[
                                    ...
                                    <Reveal key={step.title} delayMs={i * 90} className="h-full">
                                        <div className="relative h-full overflow-hidden rounded-2xl border border-white/10 bg-black/30 p-6">
                    ...
                    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
                        <Reveal>
                            <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent p-8 lg:p-10">
